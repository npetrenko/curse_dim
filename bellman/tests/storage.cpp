...
TEST(Cluster, CopyConstruct) {
    ParticleCluster first_cluster{NumParticles(2), ZeroInitializer<MemoryView>(ParticleDim{1})};
...
TEST(Cluster, CopyAssing) {
    ParticleCluster first_cluster{NumParticles(2), ZeroInitializer<MemoryView>(ParticleDim{1})};
    ParticleCluster second_cluster{NumParticles(1),
                                   ConstantInitializer<MemoryView>(1., ParticleDim{2})};
